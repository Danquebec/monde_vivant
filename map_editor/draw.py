...
class Interface():
    ...
    def prepare_menu(self):
        ...
        # made simpler.
        def get_text_surfaces_and_rects(item, color, pos):
        ...
        for list_of_item in (non_selectable_items, selectable_items):
